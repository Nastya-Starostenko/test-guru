...
ActiveRecord::Schema.define(version: 2022_08_22_134423) do
  ...
  create_table "badges", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["image_url"], name: "index_badges_on_image_url", unique: true
  ...
  create_table "tests", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.integer "time", default: 15, null: false, comment: "Time for passing test"
